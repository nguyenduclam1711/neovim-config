...

  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set('n', '<leader>ghr', require('gitsigns').reset_hunk, { buffer = bufnr, desc = 'Reset git hunk' })
        ...
        vim.keymap.set('n', '<leader>ghb', function() require('gitsigns').blame_line { full = true } end,
          { buffer = bufnr, desc = 'Blame this' })
        vim.keymap.set('n', '<leader>ghs', require('gitsigns').stage_hunk, { buffer = bufnr, desc = 'Stage this hunk' })
